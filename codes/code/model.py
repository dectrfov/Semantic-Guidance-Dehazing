...
from ldwgan import fusion_net

train_size=(1,3,512,512)
...
class fusion_net_base(Local_Base, fusion_net):
    def __init__(self, *args, base_size=None, fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        fusion_net.__init__(self, *args, **kwargs)
